...
For a given effect $\beta_x$, associated to a certain $x$ exposition:
...
The **overall cumulative effect** $\beta_{x,\,\text{overall}}$ can be used as $\beta_x$ (forward perspective)
...
- It provides a full DLNM workflow in just a few steps: model fitting, prediction, and attribution
