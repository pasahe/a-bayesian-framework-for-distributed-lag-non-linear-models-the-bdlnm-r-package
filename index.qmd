...
DLNMs [@gasparrini] are the standard framework for capturing these short-term dynamics, simultaneously modelling two dimensions of risk:
...
#| out-width: "100%"
par(mar = c(4, 4, 3, 1))
plot(cpred, ptype = "3d", main = "Exposure-lag-response surface", zlab = "RR", xlab = "Temperature (ºC)")
```
