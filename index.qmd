...
- Therefore, if we have estimated $\beta_x$ associated with a certain $x$ exposure in a time $t$ (**centered to an optimal reference one**) we can calculate the attribution to non-optimal temperature exposure as:
