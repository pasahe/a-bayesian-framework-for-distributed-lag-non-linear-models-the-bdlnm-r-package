...
- If we have estimated $\beta_x$ associated with a certain exposure, we can calculate its corresponding attribution as:
...
```{r}
rbind(
  "Attributable fraction" = paste0(round(attr$aftotal.summary[c("0.5quant", "0.025quant", "0.975quant")]*100, 2), "%"),
  "Attributable number" = format(
